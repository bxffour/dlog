...
import (
	...
	"github.com/bxffour/dlog/internal/auth"
	"github.com/bxffour/dlog/internal/discovery"
	"github.com/bxffour/dlog/internal/log"
	"github.com/hashicorp/raft"
	"github.com/soheilhy/cmux"
	"go.uber.org/zap"

	"github.com/bxffour/dlog/internal/server"
...
func New(config Config) (*Agent, error) {
	...
	for _, fn := range setup {
		if err := fn(); err != nil {
			return nil, fmt.Errorf("error running setup func: %w", err)
		}
	}
...
func (a *Agent) setupLog() error {
	...
	if err != nil {
		return fmt.Errorf("setupLog: RPCAddr: %w", err)
	}
...
func (a *Agent) setupServer() error {
	...
	if err != nil {
		return fmt.Errorf("setupServer: NewGRPCServer: %w", err)
	}
...
func (a *Agent) setupMembership() error {
	rpcAddr, err := a.Config.RPCAddr()
	if err != nil {
		return fmt.Errorf("setupMembership: congig.RPCAddr: %w", err)
	}
